                ...
                <div>
                    <Accordion defaultActiveKey="0" className="container faq">
                        ...
                        <Accordion.Item eventKey="1">
                            <Accordion.Header>What products do your company offer?</Accordion.Header>
                            <Accordion.Body>
                                BlueMediQ MEDICAL is the world's leading high-tech manufacturing company committed to R&D, production and marketing of medical and healthcare protective devices including nitrile gloves, face-masks, isolation gowns, surgical gowns, protective coveralls, melt blown fabrics and etc.
                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item eventKey="2">
                            <Accordion.Header>What is the FDA's policy on medical gloves during COVID-19?</Accordion.Header>
                            <Accordion.Body>
                                The FDA issued a guidance document entitled Enforcement Policy for Gowns, Other Apparel, and Gloves During the Coronavirus Disease (COVID-19) Public Health Emergency to provide a policy to help expand the availability of these items for health care professionals.
                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item eventKey="3">
                            <Accordion.Header>What do Nitrile gloves protect against?</Accordion.Header>
                            <Accordion.Body>
